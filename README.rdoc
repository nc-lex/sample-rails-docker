...
Note that <code>.docker/entrypoint.sh</code> will automatically attempt to initialize the database when starting the server. Change to the desired behavior if needed.
...
Setup: Apple OS X 10.11.4, Intel Core 2 Duo 3.06GHz, 16GB DDR3, HDD.
