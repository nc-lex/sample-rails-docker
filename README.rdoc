...
Dinghy addresses the #1 issue. For example, through NFS file sharing <code>rake test</code> for this sample app takes around 1.2x time it takes on the host. (In comparison, through VirtualBox file shares it takes around 2.0x time)
