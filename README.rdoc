...
Note that <code>.docker/entrypoint.sh</code> will automatically attempt to initialize the database when starting the server. It also defines how to start the server. Change to the desired behavior if needed.
