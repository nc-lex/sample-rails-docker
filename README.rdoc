...
0. Follow Step 1 from https://docs.docker.com/docker-for-mac/ to install Docker.

0. Run <code>docker-machine stop</code> to stop Docker Machine if it's running. Disable 
