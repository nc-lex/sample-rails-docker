...
image::
  The "base class" of containers. Defines how a container is created. <code>debian</code>, <code>mysql</code> are among the useful images. They are built from steps defined in a <code>Dockerfile</code>
